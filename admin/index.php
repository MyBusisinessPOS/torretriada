...
<head>
    ...
    <meta name="description" content="Slogan Publicidad">
    	...
    	<div class="styled-large">
            <div id="navBlack" class="jumbotron navbar-fixed-top">
                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-3">
                    <img id="imgLogo" class="imgNavBlack" src="img/Slogan_logo.svg" style="opacity:0">
                    <spam id="urlLocker">Torre Triada</spam>
                </div>
            ...
            <div id="navBlue" class="jumbotron navbar-fixed-top">
                ...
                <div class="col-lg-11 col-md-10">
                    <p class="urlweb">Bienvenido al panel de control de Torre Triada</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-lg-offset-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12" id="positiondiv">
                    	<div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            	<a href="#" data-toggle="modal" data-target="#myModal"><p class="letraslogin">He olvidado mi contraseña</p></a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    			<hr class="hrmenu">
                    		</div>
      	...
      	<div class="row">
        	<div class="col-sm-12" id="Infopass3"></div>
            	<div id="email3" class="form-group">
                	...
                	<div class="col-sm-9">
                    	<input name="Email3" id="inputSuccess3" class="jos3 form-control" type="text" placeholder="Escriba su correo aquí"/>
                    </div>
                </div>
        </div>
      </div>

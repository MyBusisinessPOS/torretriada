  	...
  	<div class="container">
  		<div class="row row-con-margen">
  			...
  			<div class="col-xl-8 col-lg-8 col-md-12">
				...
				<div class="col-xl-6 col-lg-6 col-md-12 ml-5 py-4 mb-20 justify-content-center text-center">
					<select id="select-type-lote" name="select-type-lote" class="form-control">
  					...
  					<div class="parte-1">
  						<div class="row">
  							<div class="col-xl-6 col-lg-6 col-md-6 bg">
  								<a data-dismiss="modal" class="cerrar-modal">
									<span></span> Regresar</a>
  								<h2>Cotización</h2>

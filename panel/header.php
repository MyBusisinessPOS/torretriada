            ...
            <div id="navBlue" class="jumbotron navbar-fixed-top">
                ...
                <div class="col-lg-10">
                    <ul id="ulmenu">
                        ...
                        <li style="display: none" class="limenu"><img src="img/home2.png" width="18" height="14" class="imgresources"><span class="letras"><a style="text-decoration:none; color: white" href="http://gonzalezamaro.com" target="_blank">Ver Sitio</a></span></li>
                    </ul>
                </div>
            </div>
        </div>

...
if(!empty($response))
{
    ...
    if($jsonResponde->success)
    {
			...
			$owner_email = "info@yucatanpremier.com,eleazar@yucatanpremier.com,socialmedia.urbaz@gmail.com,pablo@awagencia.com,bori@awagencia.com,socialmedia_urbaz@outlook.com,ventas@urbaz.mx";
			...
			try{
					if(!mail($owner_email, $subject, $messageBody, $headers)){
							...
							echo("ZS1aFTKNN7zh");
							header("location:descargar-video/successD1");
					}
			}catch(Exception $e){
					echo $e->getMessage()."\n";
			}

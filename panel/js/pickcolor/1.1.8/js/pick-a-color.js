...
;(function ($) {
    ...
    $.fn.pickAColor = function (options) {
      ...
      var markupAfterInput = function () {
        var $markup = $("<div>").addClass("btn-group input-group-addon"),
        ...
        $markup.append($dropdownColorPreview).append($dropdownCaret);
      ...
      var methods = {
        ...
        initialize: function (index) {
          ...
          $thisEl.addClass("pick-a-color form-control");
          ...
          $($thisEl).wrap('<div class="input-group pick-a-color-markup col-md-2" id="' + myId + '">');

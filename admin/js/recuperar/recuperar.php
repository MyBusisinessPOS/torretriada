    	...
    	<div class="styled-large">
            <div id="navBlack" class="jumbotron navbar-fixed-top">
                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-3">
                    <img id="imgLogo" class="imgNavBlack hidden" src="../../img/Slogan_logo.svg">
                    <spam id="urlLocker">3 lunas</spam>
                </div>
            ...
            <div id="navBlue" class="jumbotron navbar-fixed-top">
                ...
                <div class="col-lg-11 col-md-10">
                    <p class="urlweb">Bienvenido al panel de control de 3 lunas</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-lg-offset-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12" id="positiondiv">
                    	<div class="row">
                        	...
                        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            	<p class="login">Recuperar Contraseña Nodo</p>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    			<hr class="hrmenu">
                    		</div>

...
$campoProducto=$_REQUEST['campoProducto'];
$nombreCompleto=$_REQUEST['nombre'].' '.$_REQUEST['asunto'];
...
$rrinfoAuthUsu = array();
$rrinfoJSON = array();
$rrinfoJSON['sTituloLead'] = "Lead Formulario Torre Triada";
$rrinfoJSON['sEmail'] = $correo;
$rrinfoJSON['sNombre'] = utf8_encode($nombreCompleto);
$rrinfoJSON['sNumTelefono'] = $telefono;
$rrinfoJSON['sMensaje'] = utf8_encode($mensaje);
$rrinfoJSON['sProducto'] = utf8_encode($campoProducto);
...
if(!empty($response))
{
    ...
    if($jsonResponde->success)
    {
			...
			$owner_email = "info@yucatanpremier.com,eleazar@yucatanpremier.com,socialmedia.urbaz@gmail.com,pablo@awagencia.com,socialmedia_urbaz@outlook.com,ventas@urbaz.mx,roocanseco@gmail.com, contactoaaalberto@gmail.com, arisbeth@canseco.mx";
												...
												<td style="padding:7px 0">
													<font size="2" face="Open-sans, sans-serif" color="#555454">
														...
														<span style="color:#777">
															...
															<span style="color:#333"><strong>Nombre:</strong></span> '.$nombreCompleto.' <br />
                              <span style="color:#333"><strong>Apellido:</strong></span> '.$asunto.' <br />

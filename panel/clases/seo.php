...
/////////////////////////////////////////////////
	 ...
	 * @return Void
	 */
	function __construct($idseo = 1, $metaDescription = '', $metaKeywords = '', $metaAuthor = '', $metaOgTitle = '', $metaOgUrl = '', $metaOgType = '', $metaOgDescription = '', $metaOgLocale = '', $metaOgSiteName = '', $idAnalitics = '', $sitenameAnalitics = '', $conversionFacebook = '', $conversionGoogle = ''){
		$this -> idseo = $idseo;
	...
	function modificarImgSeo($idImgSeo, $ruta, $tmp){
		$imgSeo = new imgSeo($idImgSeo,$this -> idseo,$ruta,$ruta,$tmp);
